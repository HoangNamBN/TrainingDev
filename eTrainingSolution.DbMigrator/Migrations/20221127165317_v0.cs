    ...
    public partial class v0 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Facults", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Facults_Schools_SchoolID",
                        column: x => x.SchoolID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Classroom_Facults_FacultID",
                        column: x => x.FacultID,
                        principalTable: "Facults",
                        principalColumn: "ID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Classroom_ClassroomsID",
                        column: x => x.ClassroomsID,
                        principalTable: "Classroom",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_Users_Facults_FacultID",
                        column: x => x.FacultID,
                        principalTable: "Facults",
                        principalColumn: "ID");
                    table.ForeignKey(
